			...
			<div class="content">
				...
				<div class="users-content" style="background-image:url(/img/3.jpg);">
					...
					<div class="control">
						...
						<button type='button'>
							<svg class="control-icon heart"　onclick="favorite(this)" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
								 viewBox="0 0 512 512" xml:space="preserve">
								<g>
									<path class="st0" d="M473.984,74.248c-50.688-50.703-132.875-50.703-183.563,0c-17.563,17.547-29.031,38.891-34.438,61.391
										c-5.375-22.5-16.844-43.844-34.406-61.391c-50.688-50.703-132.875-50.703-183.563,0c-50.688,50.688-50.688,132.875,0,183.547
