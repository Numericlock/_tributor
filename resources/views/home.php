...
<body>
	<div class="wrapper">
		...
		<div class="content">
				...
				-->
					...
					<div class="users-information">
						...
						<div class="information">
							<span><img class="information-icon" src="/img/comment.svg">文章-3分前-<img class="information-icon" src="/img/list2.svg"></span>
						</div>
					</div>
				</div>
			...
			<div class="users-content" style="background-image:url(/img/test.jpg);">
				<div class="users-information-wrapper">
				<!--	<img src="/img/1.jpg"></img>
				-->
					<div class="users-icon">
		...
		<div class="list">
			<a href="#"><img class="common-list-icon" src="/img/6.jpg"></a>
			<a href="#"><img class="common-list-icon" src="/img/show.jpg"></a>
			<a href="#">
