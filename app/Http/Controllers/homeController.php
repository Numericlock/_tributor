...
public function __construct()
    ...
    public function home (Request $request){
		$posts = User_post::select('users_posts.*','users.*')
		->join('users_follows', 'users_follows.followed_user_id', '=', 'users_posts.post_user_id')
        ->join('users', 'users.id', '=', 'users_posts.post_user_id')    
		->join('posts_vaild_disclosure_lists', 'users_posts.id', '=', 'posts_vaild_disclosure_lists.post_id')
		->join('disclosure_lists_users', 'disclosure_lists_users.list_id', '=', 'posts_vaild_disclosure_lists.list_id')
