...
<body>
	<div class="wrapper">
		...
		<div class="content">
				...
				-->
					...
					<div class="users-information">
						...
						<div class="information">
							<span><img class="information-icon" src="/_tributor/public/img/comment.svg">文章-3分前-<img class="information-icon" src="/_tributor/public/img/list2.svg"></span>
						</div>
					</div>
				</div>
				<div class="users-content-sentence">
					<span>-tributorにようこそ</span>
				</div>				
				<div class="control">
					<button type='button'>
			...
			<div class="users-content" style="background-image:url(/_tributor/public/img/3.jpg);">
				<div class="users-information-wrapper">
				<!--	<img src="/_tributor/public/img/1.jpg"></img>
				-->
					<div class="users-icon">
			...
			<div class="users-content" style="background-image:url(/_tributor/public/img/test.jpg);">
				<div class="users-information-wrapper">
				<!--	<img src="/_tributor/public/img/1.jpg"></img>
				-->
					<div class="users-icon">
				...
				<div class="users-content-sentence">
					<span>　</span>
					<img src="/_tributor/public/img/test.jpg">
				</div>				
				<div class="control">
					<button type='button'>
						<svg class="control-icon comment" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		<div class="list">
			<a href="#"><img class="common-list-icon" src="/_tributor/public/img/6.jpg"></a>
			<a href="#"><img class="common-list-icon" src="/_tributor/public/img/show.jpg"></a>
			<a href="#">
	...
	<div id="modal_content" class="modal-content">
        ...
        <div class="modal-textarea">
            <div class="modal-textarea-userImage">
                <img src="/_tributor/public/img/2.jpg">			        			
            </div> 
	...
	<div id="modal_content_next" class="modal-content">
        <div class="modal-title">
            <span>リストを選択する</span>
            <svg class="modal-closeButton" id="modal_cancel" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 512 512" xml:space="preserve">
	...
	<script>
		$('#dotRadius').on('click',function(){
			...
			$('#modal_content').show().stop(true, true).animate({
				top: "50%",
				display: "fixed",
				opacity: 1.0
			}, 500);
			$('#modal_content_next').show().stop(true, true).animate({
				top:"50%",
				left: "120%",
				display: "fixed",
				opacity: 0
		...
		$('.modal').on('click',function(){
			...
			$('#modal_content').stop(true, true).animate({
				top: "-100px",
				left:"50%",
				opacity: 0
			}, 500, function(){
		...
		$('.modal').on('click',function(){
			$('.modal').stop(true, true).fadeOut('500');
			$('#modal_content_next').stop(true, true).animate({
				top: "-100px",
				opacity: 0
			}, 500, function(){
				$('#modal_content_next').hide();
			});
		});	
		...
		$('#modal_cancel2').on('click',function(){
			$('.modal2').stop(true, true).fadeOut('500');
			$('.modal-content3').stop(true, true).animate({
				top: "-100px",
				opacity: 0
		...
		$('#modal_next2').on('change',function(){
			$('.modal-content4').show().stop(true, true).animate({
				left: "50%",
				display: "fixed",
				opacity: 1.0
			}, 500);
