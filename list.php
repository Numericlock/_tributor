...
/*    if (!isset($_SESSION["user_id"])) {
  ...
  */  
    //データベースに挿入
    $stmt = $bdd->prepare('SELECT * FROM  WHERE id = ?');
...
<head>
	...
	<link rel="stylesheet" href="stylesheets/plus.css">
	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<div class="content-wrapper">
				...
				<div class="lists-wrapper">
					<?php 
						$stmt = $bdd->prepare('SELECT * FROM disclosure_lists WHERE owner_user_id = ?');
		...
		<!--	
					<div class="list-content">
						...
						<div class="list-title">
							<p class="list-title-p">おっぱいまんこまんこちんこ</p>
						</div>
		...
		<div class="list">
			<a href="#"><img class="common-list-icon" src="images/2.jpg"></a>
			<a href="#"><img class="common-list-icon" src="images/2.jpg"></a>
			<a href="#"><img class="common-list-icon" src="images/2.jpg"></a>
			<a href="#"><img class="common-list-icon" src="images/2.jpg"></a>
			<a href="#"><img class="common-list-icon" src="images/2.jpg"></a>
